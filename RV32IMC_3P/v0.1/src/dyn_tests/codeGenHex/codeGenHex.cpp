...
void init()
{
   ...
   execute_instruction32(0x00000113); //                  nop
   execute_instruction32(0x00000013); //                  nop
   execute_instruction32(0x00000013); //                  nop
   execute_instruction32(0x00000413); //                  nop
   execute_instruction32(0x00000013); //                  nop
   execute_instruction32(0x00000013); //                  nop
   execute_instruction32(0x00000013); //                  nop
   execute_instruction32(0x00000013); //                  nop
