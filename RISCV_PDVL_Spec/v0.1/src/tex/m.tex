...
\indent tr\_rv32m\_mul \{ unique @c\_instr\_m\_mul \{ \\%pdvlrvm
...
\indent tr\_rv32m\_mulh \{ unique @c\_instr\_m\_mulh \{ \\%pdvlrvm
...
\indent tr\_rv32m\_mulhu \{ unique @c\_instr\_m\_mulhu \{ \\%pdvlrvm
...
\indent tr\_rv32m\_mulhsu \{ unique @c\_instr\_m\_mulhsu \{ \\%pdvlrvm
...
\indent tr\_rv32m\_div \{ unique @c\_instr\_m\_div \{ \\%pdvlrvm
...
\indent tr\_rv32m\_divu \{ unique @c\_instr\_m\_divu \{ \\%pdvlrvm
...
\indent tr\_rv32m\_rem \{ unique @c\_instr\_m\_rem \{ \\%pdvlrvm
...
\indent tr\_rv32m\_remu \{ unique @c\_instr\_m\_remu \{ \\%pdvlrvm
